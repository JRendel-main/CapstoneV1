<div class="account-pages mt-5 mb-5">
    <div class="container">
        ...
        <div class="row justify-content-center" id="successCard">
            <div class="col-md-8 col-lg-6 col-xl-5">
                <div class="card bg-pattern">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mt-3 text-center">
                            ...
                            <a href="index.html" class="btn btn-block btn-outline-success waves-effect waves-light mt-3">Back to Home</a>
                        </div>
